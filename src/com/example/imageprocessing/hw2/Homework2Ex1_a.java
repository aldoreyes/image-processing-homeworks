...
public class Homework2Ex1_a extends HomeworkBase implements OnClickListener, IIntegerResult, IBitmapResult {
	...
	public void onClick(View v) {
		...
		File dir = new File("/mnt/sdcard/Pictures/tarea2/");
		files = dir.listFiles();
	...
	public void onResult(int result, Bitmap tagBM, Set<Integer> eqTable) {
		TextView t1 = (TextView)getView().findViewById(R.id.textView1);
		TextView t2 = (TextView)getView().findViewById(R.id.textView2);
